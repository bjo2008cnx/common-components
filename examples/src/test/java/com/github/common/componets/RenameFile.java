package com.github.common.componets;
...
public class RenameFile {
    public static final String OLD_DIR = "abc";
    ...
    public static void recursiveTraversalFolder(String path) throws IOException {
        ...
        for (File file : fileArr) {
            if (file.isDirectory()) {
                ...
                if (file.getName().contains(OLD_DIR)) {
                    System.out.println(file.getCanonicalPath());
                    file.renameTo(new File(file.getCanonicalPath().replaceAll(OLD_DIR, "github")));//重命名
                } else {
