...
public class RingBuffer {
    ...
    public RingBuffer(int bufferSize, int paddingFactor) {
        ...
        AssertUtil.isTrue(bufferSize > 0L, "RingBuffer size must be positive");
        AssertUtil.isTrue(Integer.bitCount(bufferSize) == 1, "RingBuffer size must be a power of 2");
        AssertUtil.isTrue(paddingFactor > 0 && paddingFactor < 100, "RingBuffer size must be positive");
